export default function Creations() {
  const creations = [
    {
      id: 1,
      image: "../images/band2.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 2,
      image: "../images/band3.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 3,
      image: "../images/band4.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 4,
      image: "../images/band12.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 5,
      image: "../images/band7.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 6,
      image: "../images/band8.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 7,
      image: "../images/band9.jpeg",
      alt: "tyvek wristbands",
    },
    {
      id: 8,
      image: "../images/band1.jpeg",
      alt: "tyvek wristbands",
    },
  ];
  return (
    <div className="relative">
      <style>{`
            ...
            `}</style>
      {/* <div className="absolute w-full h-screen viewer"></div> */}
      ...
      <div className="flex flex-wrap items-center justify-center mt-12 gap-4 max-w-5xl mx-auto relative">
          ...
          return (
            <div className="relative group rounded-lg overflow-hidden">
              <img
                src={create?.image}
                alt={create?.alt}
                className="size-60 object-cover object-top"
              />
