...
export default function Promotional() {
  return (
    <div className="flex flex-col mx-auto w-full md:flex-row items-center justify-around text-sm border border-gray-300 rounded-md  md:max-w-7xl w-full bg-white">
